                ...
                >
                    ...
                    <div className="relative">
                        ...
                        <h2 className="text-3xl lg:text-4xl font-semibold text-foreground mb-4">
                            Experience your AI-run business in 60 seconds.
                        </h2>

                        {/* Subtext */}
                        <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                            Select your industry, company size, and workflow scope.
                            Efficidex auto-generates your agents, dashboards, workflows,
                            sample data, approvals, and insights.
                        </p>
